...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Holmes', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '赛博仙人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jokersh.me', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '道生一，一生二，二生三，三生万物。Welcome to my blog,愿你有趣、有光、有温度。',
